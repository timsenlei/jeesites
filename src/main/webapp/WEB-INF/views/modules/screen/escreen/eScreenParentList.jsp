...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/screen/escreen/eScreenParent/">E屏列表</a></li>
		<li><a href="${ctx}/screen/escreen/eScreenParent/form">E屏添加</a></li>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				<th>名称</th><th>图片路径</th><th>所属上级</th><th>是否为父节点</th><th>操作</th>
			</tr>
		</thead>
		<tbody>
